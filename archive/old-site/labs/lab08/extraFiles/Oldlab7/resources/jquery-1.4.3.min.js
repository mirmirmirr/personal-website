...
(function (E, A) {
  ...
  function ka(a, b, d) {
    if (c.isFunction(b))
      ...
      if (Ja.test(b)) return c.filter(b, e, !d);
      else b = c.filter(b, e);
    }
    return c.grep(a, function (f) {
    ...
    c = (function () {
            ...
            if ((y = h.exec(i)) && (y[1] || !r))
              if (y[1]) {
                ...
                if ((z = B.exec(i)))
                  ...
                  i = (z.cacheable ? z.fragment.cloneNode(true) : z.fragment)
                    .childNodes;
                }
            ...
            for (I in F) {
              ...
              if (i !== J)
                if (z && J && (b.isPlainObject(J) || (fa = b.isArray(J)))) {
                  ...
                  } else clone = K && b.isPlainObject(K) ? K : {};
      ...
      b.extend({
        ...
        bindReady: function () {
          if (!p) {
            p = true;
            if (u.readyState === "complete") return setTimeout(b.ready, 1);
        ...
        trim: R
          ...
          : function (i) {
              return i == null
                ? ""
                : i.toString().replace(l, "").replace(n, "");
            },
  ...
  c.extend({
    ...
    removeData: function (a, b) {
      if (c.acceptData(a)) {
        ...
        else for (var k in a) delete a[k];
      }
    },
  ...
  c.fn.extend({
    ...
    toggleClass: function (a, b) {
      ...
      return this.each(function () {
        if (d === "string")
          for (
            var f, h = 0, k = c(this), l = b, n = a.split(ga);
            (f = n[h++]);
            ...
            for (e = b ? e + 1 : f.length; h < e; h++) {
              ...
              if (
                ...
                (c.support.optDisabled
                  ? !k.disabled
                  : k.getAttribute("disabled") === null) &&
                (!k.parentNode.disabled ||
                  !c.nodeName(k.parentNode, "optgroup"))
              ) {
                a = c(k).val();
                if (b) return a;
                d.push(a);
        ...
        if ((b in a || a[b] !== A) && e && !h) {
          ...
          if (b === "tabIndex")
            return (b = a.getAttributeNode("tabIndex")) && b.specified
              ? b.value
              : Sa.test(a.nodeName) || (Ta.test(a.nodeName) && a.href)
                ? 0
                : A;
          return a[b];
        }
          ...
          if (!n)
            h.handle = n = function () {
              return typeof c !== "undefined" && !c.event.triggered
                ? c.event.handle.apply(n.elem, arguments)
                : A;
            };
          n.elem = a;
          b = b.split(" ");
    ...
    remove: function (a, b, d, e) {
      if (!(a.nodeType === 3 || a.nodeType === 8)) {
        ...
        var f,
          ...
          B,
          D,
          H = a.nodeType ? "events" : "__events__",
          w = c.data(a),
          G = w && w[H];
        if (w && G) {
    ...
    trigger: function (a, b, d, e) {
      ...
      if (!a.isPropagationStopped() && e) c.event.trigger(a, b, e, true);
        ...
        var k,
          ...
          s = c.event.special[l] || {};
        if (
          (!s._default || s._default.call(d, a) === false) &&
          !n &&
      ...
      live: {
        add: function (a) {
          c.event.add(
            ...
            c.extend({}, a, { handler: Ga, guid: a.handler.guid }),
          );
        },
        remove: function (a) {
  ...
  c.each(
    "blur-sm focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error".split(
      " ",
    ),
    function (a, b) {
      c.fn[b] = function (d, e) {
  ...
  (function () {
      ...
      if (q.length > 1 && s.exec(g))
        ...
        if (j) {
          t = m
            ...
            : l.find(
                q.pop(),
                q.length === 1 && (q[0] === "~" || q[0] === "+") && j.parentNode
                  ? j.parentNode
                  : j,
                R,
              );
        ...
        if (N)
          if (j && j.nodeType === 1)
            for (g = 0; C[g] != null; g++) {
              if (
                C[g] &&
                (C[g] === true || (C[g].nodeType === 1 && l.contains(j, C[g])))
              )
                o.push(x[g]);
            }
          else
    ...
    l.filter = function (g, j, o, m) {
      for (
        var p = g, q = [], t = j, x, C, P = j && j[0] && l.isXML(j[0]);
        g && j.length;
        ...
        find: {
          ...
          NAME: function (g, j) {
            if (typeof j.getElementsByName !== "undefined") {
              for (
                var o = [], m = j.getElementsByName(g[1]), p = 0, q = m.length;
                p < q;
                p++
              )
        ...
        filter: {
          PSEUDO: function (g, j, o, m) {
            ...
            if (q) return q(g, o, j, m);
              ...
              return (
                (g.textContent || g.innerText || l.getText([g]) || "").indexOf(
                  j[3],
                ) >= 0
              );
            else if (p === "not") {
          ...
          TAG: function (g, j) {
            return (
              (j === "*" && g.nodeType === 1) || g.nodeName.toLowerCase() === j
            );
          },
          CLASS: function (g, j) {
            return (
    ...
    try {
      ...
      D = function (g, j) {
        var o = j || [],
          m = 0;
        if (f.call(g) === "[object Array]") Array.prototype.push.apply(o, g);
        else if (typeof g.length === "number")
          for (var p = g.length; m < p; m++) o.push(g[m]);
        else for (; g[m]; m++) o.push(g[m]);
        return o;
      };
    }
    var w, G;
    ...
    l.contains = u.documentElement.contains
      ? function (g, j) {
    ...
    var M = function (g, j) {
      for (
        var o = [], m = "", p, q = j.nodeType ? [j] : j;
        (p = n.match.PSEUDO.exec(g));
  ...
  c.extend({
    ...
    dir: function (a, b, d) {
      ...
      for (
        a = a[b];
        a && a.nodeType !== 9 && (d === A || a.nodeType !== 1 || !c(a).is(d));
  ...
  c.fn.extend({
    text: function (a) {
      ...
      if (typeof a !== "object" && a !== A)
        return this.empty().append(
          ((this[0] && this[0].ownerDocument) || u).createTextNode(a),
        );
      return c.text(this);
    },
    wrapAll: function (a) {
    ...
    clone: function (a) {
      var b = this.map(function () {
        if (!c.support.noCloneEvent && !c.isXMLDoc(this)) {
          ...
          return c.clean(
            [d.replace(xa, "").replace(cb, '="$1">').replace($, "")],
            e,
          )[0];
    ...
    domManip: function (a, b, d) {
      ...
      if (this[0]) {
        ...
        l = e.fragment;
        if (
          (f = l.childNodes.length === 1 ? (l = l.firstChild) : l.firstChild)
        ) {
          b = b && c.nodeName(f, "tr");
          f = 0;
            ...
            d.call(
              b
                ? c.nodeName(this[f], "table")
                  ...
                  : this[f]
                : this[f],
              f > 0 || e.cacheable || this.length > 1 ? l.cloneNode(true) : l,
            );
        }
            ...
            if (!c.support.tbody) {
              ...
              for (n = l.length - 1; n >= 0; --n)
                c.nodeName(l[n], "tbody") &&
                  ...
                  l[n].parentNode.removeChild(l[n]);
            }
            !c.support.leadingWhitespace &&
              $.test(k) &&
              v.insertBefore(b.createTextNode($.exec(k)[0]), v.firstChild);
            k = v.childNodes;
          }
  ...
  var Ca = /alpha\([^)]*\)/i,
    ...
    Ma = ["Top", "Bottom"],
    W,
    ib = u.defaultView && u.defaultView.getComputedStyle,
    jb = function (a, b) {
      ...
      c.ajax({
        ...
        complete: function (k, l) {
          if (l === "success" || l === "notmodified")
            h.html(
              f
                ? c("<div>").append(k.responseText.replace(lb, "")).find(f)
                : k.responseText,
            );
      ...
      return this.map(function () {
        ...
        .filter(function () {
          return (
            this.name &&
            !this.disabled &&
            (this.checked || mb.test(this.nodeName) || nb.test(this.type))
          );
        })
        .map(function (a, b) {
          var d = c(this).val();
    ...
    ajax: function (a) {
      ...
      if (b.dataType === "jsonp") {
        if (h === "GET")
          T.test(b.url) ||
            (b.url +=
              (ia.test(b.url) ? "&" : "?") + (b.jsonp || "callback") + "=?");
      ...
      if (a || a === 0) return this.animate(S("show", 3), a, b, d);
        ...
        for (b = this.length; a < b; a++) {
          ...
          this[a].style.display === "" &&
            ...
            c.data(this[a], "olddisplay", oa(this[a].nodeName));
        }
        for (a = 0; a < b; a++)
    ...
    "getBoundingClientRect" in u.documentElement
      ...
      : function (a) {
          ...
          f = (e = e.defaultView)
            ...
            : b.currentStyle;
          for (
            var l = b.offsetTop, n = b.offsetLeft;
            ...
            if (b === d) {
              ...
              if (
                ...
                !(c.offset.doesAddBorderForTableAndCells && vb.test(b.nodeName))
              ) {
    ...
    offsetParent: function () {
      return this.map(function () {
        for (
          ...
          a && !Fa.test(a.nodeName) && c.css(a, "position") === "static";
    ...
    c.fn[d] = function (e) {
      ...
      return c.isWindow(f)
        ...
        : f.nodeType === 9
          ...
          : e === A
            ? parseFloat(c.css(f, d))
            : this.css(d, typeof e === "string" ? e : e + "px");
    };
  });
})(window);
