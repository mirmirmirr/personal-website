    ...
    $.ajax({
        ...
        success: function(responseData, status){
          ...
          $(responseData).find("item").each(function() {
            ...
            output += '<p class="text-title">' + $(this).find("title").text() + '</p>';
            output += '<p class="text-body">' + $(this).find("description").text() + '</p>';
    ...
    $.ajax({
        ...
        success: function(responseData, status){
          ...
          $(responseData).find("entry").each(function() {
            output += '<div class="card">';
            output += '<p class="text-title">' + $(this).find("title").text() + '</p>';
            output += '<p class="text-body">' + $(this).find("summary").text() + '</p>';
