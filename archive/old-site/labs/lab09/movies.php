...
<?php
  ...
  echo '<script type="text/javascript" src="resources/movies.js"></script>'
...
<?php
  if ($dbOk) {
    ...
    echo '<tr><th>Movie Title:</th><th>Release Year:</th><th></th></tr>';
    for ($i=0; $i < $numRecords; $i++) {
      ...
      echo '</td><td>';
      echo '<img src="resources/delete.png" class="delete deleteMovie" width="16" height="16" alt="delete movie"/>';
      echo '</td></tr>';
